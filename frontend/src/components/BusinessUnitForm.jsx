...
import { addBusiness, updateBusiness } from "../services/api";

export default function BusinessUnitForm({ onClose, editData }) {
  ...
  const handleSubmit = async () => {
    try {
      ...
      if (editData) {
        await updateBusiness(editData._id, form, token);
        alert("Updated Successfully ✅");
      } else {
        await addBusiness(form, token);
